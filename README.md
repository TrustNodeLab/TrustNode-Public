...
- 🔗 **Проверка ссылок** — фишинговые домены, вредоносные URL (локальные эвристики и списки, без внешних сервисов)
- 🤖 **AI-помощник** — объяснение угроз, советы по защите
- 🧠 **BERT AI-модель** — on-device нейросеть для детекции текстового мошенничества (работает офлайн)
- 🎙️ **Анализ голоса** — распознавание мошеннических звонков через on-device STT (Vosk, только с явного согласия)
...
Скачайте APK из раздела **[Releases](https://github.com/TrustNodeLab/TrustNode-Public/releases)**. Доступны сборки под архитектуры ARM64, ARMv7 и x86_64. Работает без Google Play Services — совместимо с RuStore и мод-хранилищами.
